...
def train(args, models, criterion, optimizers, schedulers, dataloaders):
    ...
    if args.method in ['Random', 'Uncertainty', 'Coreset', 'BADGE', 'CCAL', 'SIMILAR', 'VAAL', 'WAAL']:  # add new methods like VAAL
...
def get_models(args, nets, model, models):
    # Normal
    if args.method in ['Random', 'Uncertainty', 'Coreset', 'BADGE', 'VAAL', 'WAAL']: # add VAAL
...
def get_optim_configurations(args, models):
    ...
    # Normal
    if args.method in ['Random', 'Uncertainty', 'Coreset', 'BADGE', 'VAAL', 'WAAL']: # also add new methods
